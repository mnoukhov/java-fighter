...
public class Type2 extends Character
{
	...
	Type2(int x, int y)
	{
		...
		try{
		sprite_r = ImageIO.read(new File("S_R.png"));
		sprite_l = ImageIO.read(new File("S_L.png"));

		spr_run_l[0] = ImageIO.read(new File("S_Run_l_1.png"));
		spr_run_l[1] = ImageIO.read(new File("S_Run_l_2.png"));
		spr_run_l[2] = ImageIO.read(new File("S_Run_l_3.png"));
		spr_run_l[3] = ImageIO.read(new File("S_Run_l_4.png"));
		spr_run_l[4] = ImageIO.read(new File("S_Run_l_5.png"));
		spr_run_l[5] = ImageIO.read(new File("S_Run_l_6.png"));
		spr_run_l[6] = ImageIO.read(new File("S_Run_l_7.png"));
		spr_run_l[7] = ImageIO.read(new File("S_Run_l_8.png"));
		spr_run_l[8] = ImageIO.read(new File("S_Run_l_9.png"));

		spr_run_r[0] = ImageIO.read(new File("S_Run_r_1.png"));
		spr_run_r[1] = ImageIO.read(new File("S_Run_r_2.png"));
		spr_run_r[2] = ImageIO.read(new File("S_Run_r_3.png"));
		spr_run_r[3] = ImageIO.read(new File("S_Run_r_4.png"));
		spr_run_r[4] = ImageIO.read(new File("S_Run_r_5.png"));
		spr_run_r[5] = ImageIO.read(new File("S_Run_r_6.png"));
		spr_run_r[6] = ImageIO.read(new File("S_Run_r_7.png"));
		spr_run_r[7] = ImageIO.read(new File("S_Run_r_8.png"));
		spr_run_r[8] = ImageIO.read(new File("S_Run_r_9.png"));


		spr_dash_r = ImageIO.read(new File("S_Dash_R.png"));
		spr_dash_l = ImageIO.read(new File("S_Dash_L.png"));

		spr_jump_r = ImageIO.read(new File("S_Jump_R.png"));
		spr_jump_l = ImageIO.read(new File("S_Jump_L.png"));

		spr_fall_r = ImageIO.read(new File("S_Fall_R.png"));
		spr_fall_l = ImageIO.read(new File("S_Fall_L.png"));

		spr_punch_l = ImageIO.read(new File("S_Punch_L.png"));
		spr_punch_r = ImageIO.read(new File("S_Punch_R.png"));
